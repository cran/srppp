...
date: 13 August, 2024 (rebuilt `r Sys.Date()`)
...
substance names in the official languages of Switzerland. The first 
four entries out of `r nrow(current_register$substances)` are shown 
below.
...
For specific uses, e.g. for uses number `1` and `2` of product "Boxer"
with W-Number `6168`, the associated culture form and the registered
